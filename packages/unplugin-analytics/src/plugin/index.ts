...
export const UnpluginAnalyticsRuntime: UnpluginInstance<Options | undefined, false> =
  createUnplugin<Options | undefined, false>((options = {}) => {
...
export const UnpluginAnalytics: UnpluginInstance<Options | undefined, false> = createUnplugin<
  Options | undefined,
  false
>((options = {}) => {
  let isDev = false;
